...
void FakeIMUModule::update(unsigned long time) {
    float ax = 10 * (rand() - 0.5);
    float ay = 10 * (rand() - 0.5);
    float az = 10 * (rand() - 0.5);

    float gxDPS = 10 * (rand() - 0.5);
    float gyDPS = 10 * (rand() - 0.5);
    float gzDPS = 10 * (rand() - 0.5);

    float mx = 10 * (rand() - 0.5);
    float my = 10 * (rand() - 0.5);
    float mz = 10 * (rand() - 0.5);
