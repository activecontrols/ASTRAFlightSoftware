...
#define FASTMAVLINK_MSG_ENTRY_SCALED_IMU  {26, 158, 28, 0, 0, 0}
...
#define FASTMAVLINK_MSG_ENTRY_COMMAND_SIMPLE  {51880, 18, 127, 0, 0, 0}
...
#define FASTMAVLINK_MSG_ENTRIES {\
  ...
  FASTMAVLINK_MSG_ENTRY_COMMAND_SIMPLE\
}
